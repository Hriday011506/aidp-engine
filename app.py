...
def generate():
    ...
    demand_factor=float(np.clip((pred-700)/5000,-0.045,0.045))
    weather_factor=float(np.clip((temp-27)/250,-0.025,0.025))
    holiday_factor=float(np.clip(holiday/600,-0.012,0.012))
    trend_factor=float(np.clip((trend_score-60)/3000,-0.015,0.015))
